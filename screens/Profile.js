...
import { StyleSheet, Text, View, Button, SafeAreaView, Platform, StatusBar, Image, TouchableOpacity, Switch } from "react-native";
      ...
      return (
        <View style={styles.container}>
          ...
          <View style={styles.screenContainer}>
            ...
            <View style={styles.themeContainer}> <Text style={styles.themeText}> Dark Theme</Text>
              <Switch style={{ transform: [{ scaleX: 1.3 }, { scaleY: 1.3 }] }}
                trackColor={{ false: "#757677", true: "white" }}
